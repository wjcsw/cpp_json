...
enum parse_state {PARSE_COMPLETE, PARSE_WRONG_WORD, PARSE_EXTRA_WORD, PARSE_NO_WORD, PARSE_NO_DOUBLE_QUOTSTION, PARSE_INVALID_UNICODE, PARSE_NO_SQUARE_BRACKET, PARSE_NO_CURLY_BRACKET, PARSE_MISSING_COMMA, PARSE_MISSING_COLON, PARSE_INVALID_ESCAPE, PARSE_MISSING_KEY
